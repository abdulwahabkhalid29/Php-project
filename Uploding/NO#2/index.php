...
<body class="img1">
<div class="container" style="border: red 10px groove; margin: 100px;"> 
            <div class="p-5"> 
        <form action="Upload_img.php" method="POST" enctype="multipart/form-data">
            <h1 class="text-center text-success pb-4 display-5"><b><strong> Php Form:-</strong></b></h1>
            <div class="row">
            ...
            <input type="text" name="Lname" class="form-control" placeholder="Enter your Last Name">
                ...
                <div class="col-md-6 mt-4">
            <input type="password" name="E-mail" class="form-control" placeholder="Enter Your password">
             </div>
            <div class="col-md-6 mt-4">
